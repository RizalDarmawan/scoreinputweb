    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">
            <a href="tables.php">Tabel Siswa</a>
          </li>
              ...
              <table class="table table-bordered" id="kucing" class="dataTable" width="100%" cellspacing="0">
                ...
                <!-- Data mapel -->
                  ...
                  <form action="" method="post">
                    ...
                    <tr>
                      <td><?= $m; ?></td>
                      <td><input type="text" name="nama" autofocus value="<?= $mapel["nama"]; ?>"></td>
                      <td><input type="text" name="guru" value="<?= $mapel["guru"]; ?>"></td>
                      <td>
                        <button type="submit" class="btn btn-success" name="mapel">Edit</button>
                      </td>
                    </tr>
                  </form>
                  <!-- akhir Edit mapel -->
