            ...
            <div class="card text-white bg-primary o-hidden h-100">
              ...
              <span class="card-footer text-white clearfix small z-1" href="#">
                ...
                <span class="float-left">
                  ...
                  <input type="text" name="nilaiasj" required autofocus value="<?= $siswaasj["nilai"]; ?>" id="nilaiasj">
                </span>
              </span>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-warning o-hidden h-100">
              ...
              <span class="card-footer text-white clearfix small z-1" href="#">
                ...
                <input type="text" name="nilaiaij" required value="<?= $siswaaij["nilai"]; ?>" id="nilaiaij">
              </span>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-success o-hidden h-100">
              ...
              <span class="card-footer text-white clearfix small z-1" href="#">
                ...
                <input type="text" name="nilaitlj" required value="<?= $siswatlj["nilai"]; ?>" id="nilaitlj">
              </span>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card text-white bg-danger o-hidden h-100">
              ...
              <span class="card-footer text-white clearfix small z-1" href="#">
                ...
                <input type="text" name="nilaipkk" required value="<?= $siswapkk["nilai"]; ?>" id="nilaipkk">
              </span>
            </div>
          </div>
        </div>
        <div class="container">
          <div class="row">
            <div class="col text-center">
              <button class="btn btn-success" type="submit" name="nilai">Ubah Nilai</button>
            </div>
          </div>
        </div>
      <!-- /.container-fluid -->
