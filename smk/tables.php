...
<body id="page-top">
              ...
              <table class="table table-bordered" id="dataTable" class="dataTable" width="100%" cellspacing="0">
                ...
                <!-- Data siswa -->
                  ...
                  <?php foreach ( $siswa as $a ) :?>
                    <tr>
                      <td><?= $s; ?></td>
                      <td><a href="datasiswa.php?id=<?= $a["id"]; ?>"><?= $a["nama"]; ?></a></td>
                      <td><?= $a["kelas_id"]; ?></td>
                      <td><?= $a["username"]; ?></td>
                      <td><?= $a["password"]; ?></td>
                      <td><?= $a["email"]; ?></td>
                      ...
                      <td>
                        <!-- aksi siswa -->
                        <!-- edit siswa -->
                        <a href="editsiswa.php?id=<?= $a["id"]; ?>" class="link">
                          <i class="fas fa-pencil-alt"></i>
                        </a> | 
                        <!-- hapus siswa -->
                        <a href="functions.php?id=<?= $a["id"]; ?>&&tabel=siswa">
                  ...
                  <form action="" method="post">
                      <tr id="sembunyisiswa">
                        ...
                        <td><input type="text" name="kelas_id" required></td>
                        ...
                        <td>
                          <button type="submit" class="btn btn-success" name="siswa">Tambah</button>
                        </td>
                      </tr>
                  </form>
                  <!-- akhir tambah siswa -->
  ...
  <div class="modal fade" id="hapusModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Yakin Ingin Hapus Data ini?</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">Klik tombol "Hapus" di bawah untuk menghapus data yang dipilih.</div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Gak Jadi</button>
          <a class="btn btn-primary" href="functions.php?id=<?= $a["id"]; ?>&&tabel=kelas">Hapus <?= $a["id"]; ?></a>
        </div>
      </div>
    </div>
  </div>
